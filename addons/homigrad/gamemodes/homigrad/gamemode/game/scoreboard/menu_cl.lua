	...
	},
	{
		function(x, y, w, h)
			...
			function panel:Paint(w, h)
				...
				surface.SetDrawColor(255, 255, 255, 16)
				surface.DrawRect(0, 0, w, 1)
				draw.SimpleText("Saves for each map separately", "HomigradFont", 5, h / 2, self.textColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
			end
...
function OpenHomigradMenu()
	...
	HomigradMenu.Paint = function(self, w, h)
		surface.SetDrawColor(0, 0, 0, 200)
		surface.DrawRect(0, 0, w, h)
		draw.SimpleText("Skybox Menu", "HomigradFont", 10, 15, white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
