...
hl2dm.red = {
	"Повстанцы",
	Color(125, 95, 60),
	weapons = {"weapon_hands", "weapon_radio", "med_band_big", "med_band_small"},
	main_weapon = {"weapon_mk18", "weapon_spas12", "weapon_akm", "weapon_mp7"},
...
hl2dm.blue = {
	"Комбайны",
	Color(75, 75, 125),
	weapons = {"weapon_hands"}, -- выдача оружия в init.sv
