if ( string.find( string.lower( game.GetMap() ), "gm_site19" ) ) then
    ...
    resource.AddWorkshop("845068904")--SCP Sounds
    resource.AddWorkshop("764329142")--Map sounds
    resource.AddWorkshop("290599102")--Map
...
function scp.EndRound(winner)
    if winer == 1 then
    PrintMessage(3,"Выиграли: Класс D")
    elseif winer == 2 then
    PrintMessage(3,"Выиграли: МОГ")
    elseif winer == 3 then
    PrintMessage(3,"Выиграли: SCP")
    else
    PrintMessage(3,"Выиграли: Повстанцы хаоса")
    end
end
