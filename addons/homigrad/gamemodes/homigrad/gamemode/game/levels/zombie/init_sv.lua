...
local zombies = {"npc_zombie", "npc_fastzombie", "npc_headcrab", "npc_zombie_torso", "npc_headcrab_fast", "npc_fastzombie_torso",}
...
function zombie.PlayerInitialSpawn(ply)
	ply:SetTeam(2)
end
...
function zombie.PlayerDeath(ply, inf, att)
	return false
end
...
function zombie.NoSelectRandom()
	return #ReadDataMap("spawnpoints_ss_exit") < 1
end
