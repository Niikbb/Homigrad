...
riot.red = {"Полиция",Color(55,55,150),
	weapons = {"weapon_hands","weapon_police_bat","med_band_big","med_band_small","weapon_handcuffs","weapon_radio"},
	main_weapon = {"medkit","weapon_hg_flashbang","weapon_per4ik"},
	secondary_weapon = {""},
...
riot.blue = {"Бунтующие",Color(75,45,45),
	...
	main_weapon = {"weapon_molotok","weapon_hg_molotov","weapon_molotok","med_band_big","med_band_small"},
