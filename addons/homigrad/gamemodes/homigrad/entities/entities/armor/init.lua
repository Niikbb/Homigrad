...
function ENT:UpdateArmor(taker)
	local ply = (IsValid(taker:GetNWEntity("Ragdoll")) and taker:GetNWEntity("Ragdoll")) or taker
...
hook.Add("PhysgunPickup", "NoPickingArmor", function(ply, ent) if ent:GetClass() == "armor" and ent.taken then return false end end)